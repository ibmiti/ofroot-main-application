...
<link href="{{secure_asset('css/nucleo-svg.css')}}" rel="stylesheet" />
    ...
    <link id="pagestyle" href="{{ secure_asset('css/dashboard/material-dashboard.css') }}" rel="stylesheet" />
  ...
  <body class="g-sidenav-show  bg-gray-100">
    ...
    <div class="sidenav-header">
        ...
        <!-- <img src="./asset/img/logo-ct.png" class="navbar-brand-img h-100" alt="main_logo"> We can place a icon here -->
...
<div class="row">
  ...
  <div class="card-header p-3 pt-2">
    ...
    <div class="text-end pt-1">
      <a href="{{ route('createBlog') }}"><p class="text-sm mb-0 text-capitalize">Blog Admin</p></a>
  ...
  <div class="card-header p-3 pt-2 bg-transparent">
    ...
    <div class="text-end pt-1">
     <a href="{{ url('/shop/admin') }}"> <p class="text-sm mb-0 text-capitalize ">Product Admin</p></a>
...
<!--   Core JS Files   -->
<script src="{{ URL::secure ? secure_asset('/js/jquery.min.js') : asset('/js/jquery.min.js') }}"></script>
<script src="{{ URL::secure ? secure_asset('/js/jquery.scrolly.min.js') : asset('/js/jquery.scrolly.min.js') }}"></script>
<script src="{{ URL::secure ? secure_asset('/js/browser.min.js') : asset('/js/browser.min.js') }}"></script>
<script src="{{ URL::secure ? secure_asset('/js/breakpoints.min.js') : asset('/js/breakpoints.min.js') }}"></script>
<script src="{{ URL::secure ? secure_asset('/js/main.js') : asset('/js/main.js') }}"></script>
<script src="{{ URL::secure ? secure_asset('/js/util.js') : asset('/js/util.js')}}"></script>
<script>
...
<!-- Control Center for Material Dashboard: parallax effects, scripts for the example pages etc --><script src="{{ URL::secure? secure_asset('js/material-dashboard.min.js?v=3.1.0'): asset('js/material-dashboard.min.js?v=3.1.0')}}"></script>
  </body>
